            ...
            <tr>
              <td align="center">
                <table width="500" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                  <!-- Header -->
                  <tr>
                    <td style="background-color: #4A90A4; padding: 30px 40px; text-align: center;">
                    ...
                    <td style="padding: 40px;">
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="center">
                            <a href="${actionLink}" 
                               style="display: inline-block; background-color: #4A90A4; color: #ffffff; text-decoration: none; padding: 14px 40px; border-radius: 8px; font-size: 16px; font-weight: 600;">
                              Sign In to Academy
                            </a>
                          </td>
                        </tr>
                      ...
                      <p style="margin: 8px 0 0; word-break: break-all; color: #4A90A4; font-size: 12px;">
                        ${actionLink}
                      </p>
                    </td>
                  </tr>
