...
const emailWrapper = (headerTitle: string, headerColor: string, content: string) => `
<!DOCTYPE html>
<html>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f4f4f5;padding:40px 20px;">
    <tr><td align="center">
      <table width="500" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        <tr><td style="background-color:${headerColor};padding:24px 40px;text-align:center;">
...
serve(async (req) => {
  ...
  try {
    ...
    if (isPraise) {
      ...
      content = `
        ...
        <p style="color:#374151;font-size:15px;line-height:1.6;margin:0 0 16px;">
          Your manager has recognised something you've done well — nice work!
        </p>
        <table cellpadding="0" cellspacing="0" style="width:100%;margin:0 0 16px;border-collapse:collapse;">
          ...
          <tr>
            <td style="padding:6px 0;color:#6b7280;font-size:13px;vertical-align:top;">Feedback</td>
            <td style="padding:6px 0;color:#374151;font-size:14px;line-height:1.5;">${reason}</td>
          </tr>
        </table>
        <div style="border-left:3px solid #16a34a;background-color:#f0fdf4;padding:12px 16px;border-radius:0 6px 6px 0;margin:0 0 8px;">
          <p style="color:#374151;font-size:14px;line-height:1.6;margin:0;">
            <strong>How this helps your rating:</strong> consistently meeting and exceeding expectations${category ? ` in <strong>${category}</strong>` : ""}
            is exactly what lifts your performance rating — and a higher rating means a bigger share of the monthly bonus pot. Keep it up.
          </p>
        </div>
      ...
      headerTitle = "A warning has been added to your record";
      ...
      content = `
        ...
        <p style="color:#6b7280;font-size:14px;line-height:1.6;margin:16px 0 0;">
          If you'd like to discuss this or how to improve, please speak to your manager.
        </p>`;
    }
    ...
    const { error } = await resend.emails.send({
      ...
      to: [recipientEmail],
      subject,
      html: emailWrapper(headerTitle, headerColor, content),
    });
